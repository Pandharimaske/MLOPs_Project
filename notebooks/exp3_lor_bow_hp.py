...
MLFLOW_TRACKING_URI = "https://dagshub.com/Pandharimaske/MLOPs_Project.mlflow"
...
if __name__ == "__main__":
    (X_train, X_test, y_train, y_test), vectorizer = load_and_prepare_data("notebooks/IMDB Dataset.csv")
